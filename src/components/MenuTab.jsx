...
const MenuTab = () =>{
        ...
        if (themeId.productTab === 0) {
          return <div> 상세 정보 </div>
            ...
            return <div>        
                ...
                <>
                 <Review name={item.name} detail={item.detail} date ={item.date} grade ={item.grade}/>
    ...
    return(
        ...
        <Nav.Item>
          <Nav.Link eventKey="link-0" onClick={()=>{setproductTab(0)}}>상세 설명</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-1" onClick={()=>{setproductTab(1)}}>상품후기</Nav.Link>
          <Tab productTab ={productTab}/>
        </Nav.Item>
